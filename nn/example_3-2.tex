...
\tikzset{
	neuron/.style = {circle,thick,fill=black!25,minimum size=17pt,inner sep=0pt},
	input neuron/.style = {neuron, draw, thick, fill=gray!30},
	hidden neuron/.style = {neuron, fill=white, draw},
	hoz/.style = {rotate=-90}
}

\begin{tikzpicture}[-,draw=black,node distance=\layersep, transform shape, rotate=90]
	...
	\path[yshift=0.5cm] node [hoz] () at (\layersep,-4 cm) {$\dots$};
	\path[yshift=0.5cm] node [hoz] () at (\layersep,-5 cm) {$\dots$};
